...
// Read request body as string (capped at 1 MB)
...
server.listen(PORT, () => {
  console.log(`[rupeetracker] Server running on port ${PORT}`);
  console.log(`[rupeetracker] OpenRouter AI Proxy & Broker API routes ready`);
});
