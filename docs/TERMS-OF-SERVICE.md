...
By using RupeeTracker, you agree to these Terms of Service. If you do not agree, do not use the application.

RupeeTracker is open-source software distributed under the [MIT License](../LICENSE). These terms apply to any hosted or self-hosted deployments of the application.

---

## 2. Description of Service

RupeeTracker is a self-hosted portfolio tracking application that allows users to:
...
**RupeeTracker does not provide financial, investment, tax, or legal advice.**
...
- The developers, contributors, and maintainers of RupeeTracker are not registered financial advisors, brokers, or tax consultants

---

## 4. User Responsibilities

By using RupeeTracker, you agree that:
...
- **You verify market data independently.** Do not rely solely on RupeeTracker for time-sensitive financial decisions
- **You comply with applicable laws.** Use RupeeTracker in compliance with your local laws regarding financial data, tax reporting, and data privacy

---

## 5. Third-Party Services

RupeeTracker integrates with third-party services. Each has their own terms:
...
You are responsible for complying with each service's terms when using their APIs through RupeeTracker.

---

## 6. Data and Privacy

- RupeeTracker stores all data locally in your browser by default
...
- RupeeTracker is open-source software licensed under the [MIT License](../LICENSE)
...
- "RupeeTracker" as a name is used to identify this project and is not a registered trademark
...
You agree to indemnify and hold harmless the developers, contributors, and maintainers of RupeeTracker from any claims, damages, losses, or expenses arising from:
...
- RupeeTracker is self-hosted software. Availability depends on how you run it (local or Railway)
